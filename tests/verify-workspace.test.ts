...
test("verifyWorkspace runs npm scripts locally and succeeds on zero exit codes", async () => {
...
test("verifyWorkspace returns stdout and stderr when npm script fails", async () => {
